...
public class SettingsUI : MonoBehaviour
{
    ...
    public void ToggleCameraSmoothing(Toggle toggle)
    {
        DataManager.playerSettings.cameraSmoothing = toggle.isOn;
    }
                    ...
                    foreach(Transform setting in content)
                    {
                        switch(setting.name)
                        {
                            ...
                            case "Camera Smoothing":
                                setting.GetComponent<Toggle>().isOn = DataManager.playerSettings.cameraSmoothing;
                                break;
                            case "Silhouettes":
